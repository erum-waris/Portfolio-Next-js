      ...
      return (
        <div className="transition-all duration-1000 ease-in-out hover:shadow-[0_0_8px_6px_rgb(166,87,197)] hover:scale-105 bg-transparent rounded-sm overflow-hidden flex flex-col justify-between items-center border-2 border-purple-400 text-center">
          ...
          <Image
            ...
            layout="fill"
            objectFit="cover"
            className="shadow-[0_0_8px_4px_rgb(150,84,190)] rounded-lg"
          />
          </div>
          <div className="p-4">
            ...
            <a
              ...
              className="px-1 py-1 rounded-full  bg-gradient-to-br from-purple-600 via-pink-600 to-blue-600 "> <span className="transition-colors transform duration-300 border-2 border-transparent hover:scale-150 hover:border-[#d62c8f] bg-[#564848] rounded-full px-3 py-2 text-white">Click Here</span>
            </a>
          </div>
        </div>
      );
